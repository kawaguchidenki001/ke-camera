// js/gas-uploader.js
// GAS Web App と通信
// v1.9.0: スマホ安定優先。画像は iframe form POST で送信し、GAS応答が返らない場合もiframe完了で次へ進む。

import { GAS_WEB_APP_URL as CONFIG_GAS_WEB_APP_URL, SHARED_TOKEN as CONFIG_SHARED_TOKEN, GAS_TIMEOUT_MS } from "./config.js?v=1.9.0";
...
export async function uploadViaGas({ blob, fileName, folderName, mimeType, meta, onLog }) {
  ...
  // v1.9.0: 画像本体は hidden iframe + form POST で送る。
